...
def addArg(parser):
    ...
    parser.add_argument("--smooth-lambda", type=float, default=0.99, help="hyper-parameter for smoothing, should lies in [0, 1]")
    parser.add_argument("--epsilon", type=float, default=0.0000001, help="the smallest absolute value")
    parser.add_argument("--inf", type=float, default = 1e14, help="the infinitelt long path")