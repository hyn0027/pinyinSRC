...
def addArg(parser):
    ...
    parser.add_argument("--word-freq", required=False, default="./data/", help="File path to the word freqency")
    ...
    parser.add_argument("--input", default="../data/input.txt", help="the pinyin input file")
    parser.add_argument("--std-output", default="../data/std_output.txt", help="the answer to the input file")
    parser.add_argument("--output", default="../data/output.txt", help="the Chinese output file")
    ...
    parser.add_argument("--hash-mod", default=13, help="a factor for hash")
    parser.add_argument("--hash-p", default=7, help="a factor for hash")
    parser.add_argument("--only-title", default=True, help="only use title from corpus wiki-zh")